...
import 'package:trendy_shop/controllers/auth/sign_up_check_email.dart';
...
class _SignUpCheckEmailScreenState extends State<SignUpCheckEmailScreen> {
  SignUpCheckEmailControllerImp checkEmailController = Get.put(
      SignUpCheckEmailControllerImp(),
    );
              ...
              children: [
                ...
                ActionBtn(
                  ...
                  onPressed: () {
                    ...
                    checkEmailController.goToSignUpVerifyCode();
                  },
                ),
